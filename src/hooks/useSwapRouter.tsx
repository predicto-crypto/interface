...
import { Percent, Router, Trade } from "@pancakeswap-libs/sdk-v2";
import { ethers } from "ethers";
import { ROUTER } from "../constants/contracts";
import Token from "../types/Token";
import { deduct, getContract } from "../utils";

export const FEE = new Percent("2", "1000"); // 0.3%
...
const useSwapRouter = () => {
    ...
    const swap = useCallback(async (trade: Trade, signer: ethers.Signer) => {
        if (trade) {
            ...
            const router = getContract("IPancakeRouter02", ROUTER, signer);
